      ...
      {!isMobile && (
        <div
          style={{
            ...
            padding: '60px 80px',
            background: 'linear-gradient(135deg, var(--color-ieee-dark) 0%, var(--color-ieee-primary) 100%)', // Core IEEE brand gradient
            position: 'relative',
            overflow: 'hidden',
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} style={{ textAlign: 'center', marginTop: 12 }}>
            ...
            <Link to="/login" style={{ color: 'var(--color-ieee-primary)', fontWeight: 700, marginLeft: '4px' }}>
              Sign In
            </Link>
          </motion.div>
        </motion.div>
